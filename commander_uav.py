...
class Commander:
    def __init__(self):
        ...
        self.velocity_target_pub = rospy.Publisher('/gi/set_pose/velocity', Vector3Stamped, queue_size=10)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        con.move(vx=math.pi*math.cos(theta),vy=math.pi*math.sin(theta))
        time.sleep(0.02)
        j=j+1
        if j==100:
            i=i+1
