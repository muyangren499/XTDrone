...
class Px4Controller:
    ...
    def __init__(self):
        ...
        self.set_target_velocity_sub = rospy.Subscriber("/cmd_vel", Twist, self.set_target_twist_callback)
    ...
    def set_target_twist_callback(self, msg):
        print("Received New Twist Task!")
        self.flag = 1
        self.cur_target_twist.twist.linear.x = msg.linear.x*math.cos(self.current_heading)+msg.linear.y*math.sin(self.current_heading)
        self.cur_target_twist.twist.linear.y = msg.linear.x*math.sin(self.current_heading)-msg.linear.y*math.cos(self.current_heading)
        self.cur_target_twist.twist.linear.z = 0
        self.cur_target_twist.twist.angular.x = 0
        self.cur_target_twist.twist.angular.y = 0
        self.cur_target_twist.twist.angular.z = msg.angular.z
